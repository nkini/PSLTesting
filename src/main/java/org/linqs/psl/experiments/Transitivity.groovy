package org.linqs.psl.experiments;
...
public class Transitivity {
	...
	private class PSLConfig {
        ...
        public boolean useSymmetryRule;
        public boolean useTransitivityRule;
	...
	public Transitivity(ConfigBundle cb) {
	...
	private void defineRules() {
		...
		model.add(
			rule: ( Similar(P1,P2) & (P1-P2) ) >> Same(P1,P2),
	...
	private void loadData(Partition obsPartition, Partition targetsPartition, Partition truthPartition) {
		...
		InserterUtils.loadDelimitedDataTruth(inserter, Paths.get(config.dataPath, "similar.txt").toString());
	...
	public static void main(String[] args) {
		...
		Transitivity tr = new Transitivity(configBundle);
		tr.run();
	}
}
